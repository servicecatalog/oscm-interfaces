...
public enum ConfigurationKey {
  ...
  PERMITTED_PERIOD_UNCONFIRMED_ORGANIZATIONS(
      false, "604800000", "long", Long.valueOf(1L), null, false),
  ...
  TIMER_INTERVAL_TENANT_PROVISIONING_TIMEOUT_OFFSET(
      false, "0", "long", Long.valueOf(0L), null, false),
  ...
  @Example(
      "http://<your server>:<your port>/birt/frameset?__report=${reportname}"
  ...
  @Example(
      "http://<your server>:<your port>/Report/ReportingServiceBean?wsdl or https://<your server>:<your port>/ReportSecure/ReportingServiceSecureBean?wsdl")
  ...
  @Example(
      "http://<your server>:<your port>/Report/ReportingServiceBean or https://<your server>:<your port>/ReportSecure/ReportingServiceSecureBean")
  ...
  @Doc({
    "The maximum time until an inactive on-behalf  user will be removed from the system."
  ...
  @Doc({
    "The offset of the timer for synchronizing users with the OIDC provider.",
    "The offset is in milliseconds, based on January 1, 00:00."
  })
  ...
  MAX_NUMBER_ALLOWED_USERS(
      true, "10", "long", Long.valueOf(1L), Long.valueOf(9223372036854775807L), false),
  ...
  TIMER_INTERVAL_USER_COUNT(
      true, "43200000", "long", Long.valueOf(1L), Long.valueOf(9223372036854775807L), false),
  ...
  ConfigurationKey(
      boolean isMandatory, String fallbackValue, String type, boolean isReadonly, Long length) {
    this(isMandatory, fallbackValue, type, null, null, isReadonly);
    if (!TYPE_STRING.equals(type) && (length != null)) {
      throw new IllegalArgumentException(
          "length is only allowed for configuration properties of type " + TYPE_STRING);
    }
    this.length = length;
  }

  /**
   * @throws IllegalArgumentException if the field is not of type 'long' and any of {@link
   *     #minValue} or {@link #maxValue} is set.
   */
  ConfigurationKey(
      boolean isMandatory,
   ...
   *
   * @return <code>true</code> in case the setting is mandatory, <code>false</code> otherwise.
   */
   ...
   *
   * @return <code>true</code> in case the setting is readonly, <code>false</code> otherwise.
   */
   ...
   *
   * @return The minimum value if set, <code>null</code> if not set or if the field is not of type
   *     long.
   */
   ...
   *
   * @return The maximum value if set, <code>null</code> if not set or if the field is not of type
   *     long.
   */
  ...
  /**
   * Returns the String representation of the key for the configuration setting. This one may only
   ...
   *
   * @return The length value if set, <code>null</code> if not set or if the field is not of type
   *     long.
   */
  ...
  /**
   * Prints a documented configuration file populated with all config keys and their default values.
   *
