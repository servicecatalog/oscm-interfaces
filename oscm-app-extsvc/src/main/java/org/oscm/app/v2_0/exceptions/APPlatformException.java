...
public class APPlatformException extends Exception {
         ...
         *
         * @param messages the localized text messages
         */
         ...
         *
         * @param locale the language. Specify a language code as returned by
         ...
         *
         * @param parameters the parameters and settings to store, consisting of a key and
         *                   a value each
         */
