...
public interface APPlatformController {
         ...
         *
         * @param instanceId      the ID of the application instance belonging to the
         ...
         * @return an <code>InstanceStatus</code> instance with the status of the
         * application instance
         * @throws APPlatformException In case of provisioning failures (AbortException), the
         ...
         *
         * @param instanceId the ID of the application instance to receive the notification
         * @param settings   a <code>ProvisioningSettings</code> object specifying the
         *                   service parameters and configuration settings
         ...
         * @param settings   a <code>ProvisioningSettings</code> object specifying the
         *                   service parameters and configuration settings
         * @param users      the list of users to be assigned to the subscription
         ...
         * @param settings   a <code>ProvisioningSettings</code> object specifying the
         *                   service parameters and configuration settings
         * @param users      the list of users to be deassigned from the subscription
         * @return an <code>InstanceStatus</code> instance with the status of the
         * application instance
         * @throws APPlatformException
         */
         ...
         * @param settings   a <code>ProvisioningSettings</code> object specifying the
         *                   service parameters and configuration settings
         * @param users      the list of users assigned to the subscription, including the
         ...
         *
         * @param settings a <code>ControllerSettings</code> object specifying the
         *                 controller configuration settings
         * @return the status messages
         * @throws APPlatformException
         */
        public List<LocalizedText> getControllerStatus(
         ...
         *
         * @param userId      the ID of the user who requests the operation parameter
         ...
         * @param instanceId  the ID of the application instance for which to get the
         *                    operation parameter values
         * @param operationId the ID of the operation for which to get the parameter values
         ...
         *
         * @param userId        the ID of the user who triggered the service operation. If
         ...
         * @param instanceId    the ID of the application instance for which the operation is
         *                      to be executed
         * @param transactionId the transaction ID - currently not used (<code>null</code> is
         *                      passed)
         * @param operationId   the ID of the operation to be executed as specified in the
         *                      technical service definition
         * @param parameters    the parameters of the operation with their values
         * @param settings      a <code>ProvisioningSettings</code> object specifying the
         *                      service parameters and configuration settings
         * @return an <code>InstanceStatus</code> instance with the status of the
         * application instance
         ...
         * @param instanceId   - the ID of the application instance
         * @param startTime    - start time of the usage period formatted as
         *                     <code>java.time.format.DateTimeFormatter#ISO_LOCAL_DATE_TIME</code>
         * @param endTime      - end time of the usage period formatted as
         *                     <code>java.time.format.DateTimeFormatter#ISO_LOCAL_DATE_TIME</code>
         * @param settings     a <code>ProvisioningSettings</code> object specifying the
         *                     service parameters and configuration settings
         ...
         */
        default public boolean ping(String controllerId)
                throws ServiceNotReachableException {
                return false;
        }
